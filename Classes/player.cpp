...
bool Player::init() { return initWithControl(PlayerControlType::MOUSE, 1); }
...
void Player::upgradeFirepower() {
  ...
  cocos2d::log("Player %d Weapon Upgraded! Level: %d", _playerIndex,
               _weaponLevel);
}
